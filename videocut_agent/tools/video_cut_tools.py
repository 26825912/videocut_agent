...
def add_audio_to_video(video_path, 
    ...
    :return:
    :param relative_path: 添加音频后的视频相对路径
    """ 
    save_file = None
    data_dir = get_data_dir()
...
def add_hardsub_with_offset(video_path, 
    ...
    :return:
    :param relative_path: 添加字幕后的视频相对路径
    """
...
def adjust_video_volume(video_path, 
    ...
    :return:
        :param relative_path: 调整音量后的视频相对路径
    """
    save_file = None
    data_dir = get_data_dir()
    video_path = os.path.join(data_dir,video_path)
...
def resize_and_cut_video(input_path, 
    ...
    :return:
    :param relative_path: 调整尺寸后的视频相对路径
    """ 
    save_file = None
    data_dir = get_data_dir()
    input_path = os.path.join(data_dir,input_path)
...
def clip_video(video_path: str, 
    ...
    """
    根据时间去剪切视频
    :param video_path: 视频文件相对路径
    :param duration: 剪切时长（秒）
    :param start_time: 剪切开始时间（秒）
    return:
    :param relative_path: 剪切后的视频相对路径
    """ 
    save_file = None
    data_dir = get_data_dir()
    video_path = os.path.join(data_dir,video_path)
...
def merge_videos(video_paths: List[str], 
    ...
    :return:
    :param relative_path: 合并后的视频相对路径
    """ 
    save_file = None
    data_dir = get_data_dir()
...
def insert_video_at_time(input_video_path: str, 
    ...
    :param insert_video_path: 插入视频文件路径
    :param insert_time: 插入时间（秒）
    return
    :param relative_path: 插入视频后的视频相对路径
    """ 
    save_file = None
    data_dir = get_data_dir()
...
def image_to_video(
    ...
    :param black_img_path: 图片文件路径
    :param duration: 视频时长（秒）
    :return:
    :param relative_path: 图片转换成视频后的相对路径
    """
    save_file = None
    data_dir = get_data_dir()
...
def format_video(input_path: str, 
    ...
    :return:
    :param relative_path: 规范化后的视频相对路径
    """
    save_file = None
    data_dir = get_data_dir()
    input_path = os.path.join(data_dir,input_path)
...
def remove_green_screen(input_video_path: str, 
    ...
    :return:
    :param relative_path: 去除绿幕后的视频相对路径
    :param relative_nopv_path: 去除绿幕后的背景索引视频相对路径
    """
    save_file = None
    data_dir = get_data_dir()
    input_video_path = os.path.join(data_dir,input_video_path)
...
def fill_video(fill_video,
    ...
    :return:
    :param relative_path: 填充后的视频相对路径
    """
    save_file = None
    data_dir = get_data_dir()
